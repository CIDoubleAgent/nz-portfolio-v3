...
const Resume = () => {
  ...
  return (
    <section className="resume-section">
      ...
      <a className="download-button" href="https://github.com/CIDoubleAgent/nz-portfolio-v3/blob/main/src/images/resume/Nicholas%20Zabkar%20Dev%20Resume%207_20_2023.pdf" download="Nick Zabkar Resume">Click Here To Download</a>
