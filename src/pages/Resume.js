...
const Resume = () => {
  ...
  return (
    <section className="resume-section">
      ...
      <a className="download-button" href="https://github.com/CIDoubleAgent/nz-portfolio-v3/blob/main/src/images/resume/NicholasZabkarDevResume_7-20-2023.pdf" download="Nick Zabkar Resume">Click Here To Download</a>
